 ...
 *
 * `AuthenticatesRequests`, comme `identity.auth` : il s'exécute avant `throttle`, dont les limiteurs nommés lisent `$request->user()`.
 */
class ResolveProfile implements AuthenticatesRequests
{
